...
## Purpose
This document explains how the admin analytics dashboard works in the CAPS mobile application. It serves as an administrator user guide and also documents the system flow and API usage behind the dashboard.
