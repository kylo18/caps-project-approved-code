...
const CombinedExamQuestionForm = ({ subjectID, onComplete, onCancel }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    purpose_id: 2, // 2 for exam questions
    choices: [
  ...
  return (
    <>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="max-w-[90%] text-sm text-gray-500">
                    Enter six choices. Only four will be shown to students.
      ...
      {isQuestionModalOpen && imagePreview && (
        <div
          className="bg-opacity-70 fixed inset-0 z-[9999] flex items-center justify-center bg-black"
