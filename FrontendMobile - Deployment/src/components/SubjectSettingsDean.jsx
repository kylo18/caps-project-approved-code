...
const PracticeExamConfig = ({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (localExamQuestionsEnabled !== isExamQuestionsEnabled) {
        ...
        setIsExamQuestionsEnabled(localExamQuestionsEnabled);
      }
  ...
  // Refs for scrolling
  const qeRef = useRef(null);
  const practiceRef = useRef(null);

  // Track which section is active for sidebar indicator
  const [activeSection, setActiveSection] = useState("qe");
          ...
          >
            ...
            >
              ...
              <div className="flex h-0 flex-1">
                {/* Sidebar */}
                <div className="hidden w-[190px] max-w-[300px] min-w-[190px] flex-col justify-between border-r border-gray-200 md:flex">
                  <div>
                    <nav className="mt-4 flex flex-col gap-1">
                      <button
                        className={`w-full px-4 py-3 text-left text-[13px] font-semibold transition-colors ${activeSection === "qe" ? "border-l-4 border-orange-500 bg-orange-50 text-orange-600" : "border-l-4 border-transparent text-gray-700"}`}
                      ...
                      <button
                        ...
                        onClick={() => handleSidebarScroll("practice")}
                        type="button"
                      >
                        Practice Exam
                      </button>
                ...
                <div className="practice-config-scrollable custom-scrollbar flex min-h-screen flex-1 flex-col overflow-y-auto px-5 py-4 pb-24">
                  ...
                  {!loading && !isExamQuestionsLoading && (
                    <>
                      <div ref={qeRef} className="mb-6 scroll-mt-[16px]">
                        ...
                        <div className="-mx-5 mt-3 h-[1px] bg-gradient-to-r from-transparent via-gray-300 to-transparent" />
                      </div>
