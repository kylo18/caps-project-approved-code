...
export default function ExamGenerator({ auth, isOpen, onClose }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const endpoint = `${apiUrl}/api/generate-multi-subject-exam`;
  ...
  return (
    <>
      ...
      <div className="block sm:hidden">
        {/* Form Modal */}
        {!showPreview && (
          <div className="print-exam-theme open-sans bg-opacity-40 lightbox-bg fixed inset-0 z-100 flex items-end justify-center min-[448px]:items-center">
      ...
      <div className="open-sans hidden sm:flex">
        ...
        {!showPreview && (
          ...
          >
            ...
            <div
              className={`print-exam-theme slide-in-right relative z-10 flex h-full w-[700px] min-w-[350px] transform flex-col bg-white shadow-2xl transition-all duration-300 ${isOpen ? "" : "pointer-events-none translate-x-8 opacity-0"}`}
            >
