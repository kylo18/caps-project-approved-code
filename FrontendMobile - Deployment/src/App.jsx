  ...
  return (
    <Router>
      <Routes>
        ...
        {/* AI Chat Route - Protected route for authenticated students
            Full-page chat interface with typing animation, markdown support,
            and model selection with download simulation */}
        <Route
          path="/ai-chat"
          element={<ProtectedRoute element={<Layout />} />}
        >
