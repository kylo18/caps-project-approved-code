...
export default function DeanClassesScreen() {
  ...
  useScreenFloatingTools([
    {
      ...
      icon: 'add-outline',
      label: 'Create Class',
      onPress: () => router.push('/(auth)/(dean)/class-detail'),
    },
    {
      key: 'archived',
      icon: 'archive-outline',
      label: 'Archived',
      onPress: () => router.push('/(auth)/(dean)/archived-classes'),
    },
  ]);
          ...
          filteredClasses.map((item, index) => {
            ...
            return (
              <TouchableOpacity
                ...
                onPress={() =>
                  router.push({
                    pathname: '/(auth)/(dean)/class-detail',
                    params: {
