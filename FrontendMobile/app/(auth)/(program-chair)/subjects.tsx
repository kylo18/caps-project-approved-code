...
//          and navigating to edit existing ones.
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.bg }]}>
      <View style={[styles.header, { backgroundColor: colors.card, borderBottomColor: colors.border }]}>
        ...
        <Text style={[styles.headerTitle, { color: colors.text }]}>Program Subjects</Text>
      </View>
            ...
            <View style={styles.questionsSection}>
              ...
              {questions.length === 0 ? (
                <View style={[styles.emptyState, { backgroundColor: colors.card }]}>
                  ...
                  <Text style={[styles.emptyText, { color: colors.textSecondary }]}>Start adding questions for this subject.</Text>
                </View>
              ) : (
                questions.map((q, idx) => (
                  <TouchableOpacity key={q.questionID || idx} style={[styles.questionCard, { backgroundColor: colors.card }]} activeOpacity={0.7} onPress={() => router.push({ pathname: '/(auth)/practice-exam/edit-question', params: { questionID: q.questionID } })}>
