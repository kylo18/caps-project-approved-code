...
const AdminContent = () => {
  ...
  const fetchQuestions = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${apiUrl}/api/subjects/${selectedSubject.subjectID}/questions`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
  ...
  return (
    <div className="subject-workspace-theme relative mt-7 flex min-h-screen w-full flex-1 flex-col justify-center py-2 md:mt-9">
